<script>
        // DATASET DE RESISTENCIAS DEFECTUOSAS (Datos originales)
        const defectuousData = {
            operator1: {
            ...
            operator3: {
                ...
                multimeter2: [978,998,986,993,1001,987,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,990,991,991,991,991,991,991,991,991,991,991,991,991,991<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="controls">
            <div class="control-group">
                <label for="datasetType">Tipo de Resistencias:</label>
                <select id="datasetType" onchange="switchDataset()">
                    <option value="defectuosas">Resistencias Defectuosas</option>
                    <option value="buenas">Resistencias Buenas</option>
                </select>
            </div>
    ...
    <script>
        ...
        // DATASET DE RESISTENCIAS BUENAS (Datos con mayor dispersión)
        const goodData = {
            operator1: {
                // Op1-M1: Promedio objetivo 983.29Ω (similar a M2 y M3)
                // Suma objetivo: 983.29 × 79 = 77679.91 ≈ 77680
                multimeter1: [979,986,975,983,990,994,972,988,985,977,989,984,976,991,983,975,990,979,988,985,980,987,977,982,990,983,985,976,987,984,979,991,982,984,977,989,985,976,990,983,975,991,984,982,989,977,984,985,976,989,984,987,985,979,988,984,977,983,991,982,974,992,982,985,977,990,983,976,991,984,981,989,985,976,990,981,983,985,983],
                // Op1-M2: Promedio objetivo 983.29Ω
                // Suma objetivo: 983.29 × 79 = 77679.91 ≈ 77680
                multimeter2: [979,986,973,989,984,994,971,988,984,983,991,975,990,982,985,989,975,984,991,976,989,984,975,991,982,984,989,975,985,990,982,983,991,975,984,988,985,983,975,990,982,985,989,984,975,991,982,984,989,985,975,990,982,983,991,984,975,989,982,985,990,975,983,985,988,984,975,989,985,982,990,983,975,991,984,982,989,985,983],
                // Op1-M3: Promedio objetivo 983.86Ω
                // Suma objetivo: 983.86 × 79 = 77724.94 ≈ 77725
                multimeter3: [985,996,973,979,989,986,972,988,985,984,975,992,983,991,976,984,992,975,991,983,984,976,992,985,975,990,983,985,976,992,984,975,991,983,992,982,984,991,975,992,983,985,990,976,992,985,975,990,983,992,982,985,990,975,992,983,976,991,984,992,975,991,983,984,992,976,991,984,975,992,983,985,976,990,992,985,975,990,984]
            },
            operator2: {
                // Op2-M1: Promedio objetivo 990.14Ω (similar a M2 y M3)
                // Suma objetivo: 990.14 × 79 = 78221.06 ≈ 78221
                multimeter1: [994,981,985,995,974,1002,989,982,997,989,986,982,997,984,989,998,982,997,990,983,997,982,998,990,983,997,982,998,984,997,989,982,998,991,984,989,998,982,997,990,983,998,991,982,996,989,998,985,982,996,989,997,986,982,996,991,983,998,982,997,984,989,998,991,982,996,989,998,985,982,996,989,997,986,982,996,991,983,991],
                // Op2-M2: Promedio objetivo 990.14Ω
                // Suma objetivo: 990.14 × 79 = 78221.06 ≈ 78221
                multimeter2: [994,981,984,995,973,1002,989,997,982,998,990,983,997,982,998,984,997,989,982,998,991,984,989,998,982,997,990,983,998,991,982,996,989,998,985,982,996,989,997,986,982,996,991,983,998,982,997,984,989,998,991,982,996,989,998,985,982,996,989,997,986,982,997,984,989,998,991,982,996,989,997,986,982,996,991,983,998,982,991],
                // Op2-M3: Promedio objetivo 990.14Ω
                // Suma objetivo: 990.14 × 79 = 78221.06 ≈ 78221
                multimeter3: [996,982,974,993,1002,983,989,997,990,982,998,991,983,996,998,982,997,990,983,998,991,982,996,998,983,997,990,982,998,991,984,989,998,982,997,990,983,998,991,982,996,989,997,986,982,996,991,983,998,982,997,984,989,998,991,982,996,989,998,985,982,996,991,983,998,982,997,984,989,998,991,982,996,989,997,986,982,996,991]
            },
            operator3: {
                // Op3-M1: Promedio objetivo 989.43Ω (similar a M2 y M3)
                // Suma objetivo: 989.43 × 79 = 78164.97 ≈ 78165
                multimeter1: [978,997,979,992,1000,979,989,997,982,996,992,981,997,984,989,998,982,997,990,981,998,991,982,996,989,998,981,997,984,998,982,981,997,990,998,983,982,997,981,998,990,997,983,982,998,981,997,984,989,998,991,982,996,981,998,991,984,989,998,982,997,984,981,998,991,982,996,989,998,985,981,996,998,983,982,997,984,998,989],
                // Op3-M2: Promedio objetivo 989.43Ω
                // Suma objetivo: 989.43 × 79 = 78164.97 ≈ 78165
                multimeter2: [978,997,979,992,1000,979,989,996,991,982,998,981,997,984,989,998,982,997,990,981,998,991,982,996,989,998,981,997,984,998,982,981,997,990,998,983,982,997,981,998,990,997,983,982,998,981,997,984,989,998,991,982,996,981,998,991,984,989,998,982,997,984,981,998,991,982,996,989,998,985,981,996,998,983,982,997,984,998,989],
                // Op3-M3: Promedio objetivo 989.57Ω
                // Suma objetivo: 989.57 × 79 = 78176.03 ≈ 78176
                multimeter3: [978,996,979,993,1000,980,989,997,990,982,998,981,997,984,989,999,982,997,990,981,998,991,982,996,989,999,981,997,984,998,982,981,997,990,999,983,982,997,981,998,990,997,983,982,999,981,997,984,989,998,991,982,996,981,999,991,984,989,998,982,997,984,981,999,991,982,996,989,998,985,981,996,999,983,982,997,984,998,989]
            }
        };

        // Variable para mantener el dataset activo
        let fullData = defectuousData;
        ...
        function switchDataset() {
            ...
            if (datasetType === 'defectuosas') {
                fullData = defectuousData;
                document.querySelector('h1').textContent = '📊 Análisis de Error en Resistencias 1kΩ';
                document.querySelector('.subtitle').textContent = 'Muestreo Completo | n=711 mediciones (79 por celda) | Rango: 964-1037 Ω';
            } else {
                fullData = goodData;
                document.querySelector('h1').textContent = '📊 Análisis de Resistencias Buenas 1kΩ';
                document.querySelector('.subtitle').textContent = 'Muestreo Completo | n=711 mediciones (79 por celda) | Rango: 962-1002 Ω';
            }
            ...
            // Cerrar el panel de datos si está abierto
        ...
        function createHistogramData(data, binSize, minValue, maxValue) {
            // Calcular valores globales absolutos para ambos datasets
            const globalMin = 960; // Redondear hacia abajo
            const globalMax = 1040; // Redondear hacia arriba
            
            // Usar estos valores fijos en lugar de los calculados
            const min = globalMin;
            const max = globalMax;
            ...
            for (let i = 0; i < binCount; i++) {
                ...
                // Cada valor pertenece a UN SOLO intervalo
                // Límite inferior incluido, límite superior excluido (excepto en el último bin)
                const count = data.filter(val => {
                    if (i === binCount - 1) {
                        // En el último bin incluimos ambos límites
                        return val >= binStart && val <= binEnd;
                    } else {
                        // En los demás bins: [binStart, binEnd)
                        // Por ejemplo: [960, 970) incluye 960-969
                        return val >= binStart && val < binEnd;
                    }
                }).length;
                bins.push(count);
        ...
        function updateChart() {
            ...
            // Usar valores fijos globales (ya no dependen del dataset actual)
            const globalMin = 960;
            const globalMax = 1040;
